...
<!-- Please read https://github.com/linuxserver/docker-webstation/blob/romm/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/webstation:romm` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webstation:romm
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/webstation:romm
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webstation:romm .
```
